#ifndef ATTENDANCEEVENTREPOSITORYMYSQL_H
#define ATTENDANCEEVENTREPOSITORYMYSQL_H
...
class AttendanceEventRepositoryMySQL : public AttendanceEventRepository {
public:
...
#endif // ATTENDANCEEVENTREPOSITORYMYSQL_H

#include "DepartmentRepositorySQLite.h"
    ...
    bool DepartmentRepositorySQLite::insert(const Department& department) {
        QSqlQuery query;
        query.prepare("INSERT INTO department (name, description, is_active) VALUES (:name, :desc, :is_active)");
    ...
    bool DepartmentRepositorySQLite::update(const Department& department) {
        QSqlQuery query;
    ...
    Department DepartmentRepositorySQLite::selectById(int id) {
        QSqlQuery query;
    ...
    bool DepartmentRepositorySQLite::deleteItem(int id) {
        QSqlQuery query;
    ...
    QList<Department> DepartmentRepositorySQLite::selectAll(bool condition) {

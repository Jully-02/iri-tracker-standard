...
bool UserBulletinBoardRepositoryMySQL::insert(const UserBulletinBoard& user_bulletin_board) {
    QSqlQuery query;
...
bool UserBulletinBoardRepositoryMySQL::update(const UserBulletinBoard& user_bulletin_board) {
    QSqlQuery query;
...
bool UserBulletinBoardRepositoryMySQL::deleteByBulletinBoardId(int bulletinBoardId) {
    QSqlQuery query;
...
QList<UserBulletinBoard> UserBulletinBoardRepositoryMySQL::selectByUserId(QString userId) {
...
QList<UserBulletinBoard> UserBulletinBoardRepositoryMySQL::selectByBulletinBoardId(int bulletinBoardId) {
    QList<UserBulletinBoard> user_bulletin_boards;
    QSqlQuery query;
